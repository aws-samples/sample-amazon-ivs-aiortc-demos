#!/usr/bin/env python3
"""
Static video track that displays the Deepgram logo.
...
class ScribeVideoTrack(VideoStreamTrack):
    """A video track that displays a static Deepgram logo image"""
    ...
    def _build_frame(self) -> np.ndarray:
        """Build the static frame — load logo or fall back to black with text"""
